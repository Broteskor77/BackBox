...
echo "-Disclaimer: los desarrolladores no asumen ninguna responsabilidad y no lo son"
echo "-responsable por cualquier mal uso o daño causado por BackBox"
printf $verde
echo "./start-backbox.sh"
echo ""
echo ""
#FIN